//nolint:lll // just examples
package main

var (
	seriesCreateTable = `CREATE TABLE series (                  
    	series_id Uint64,
    	title Utf8,
    	series_info Utf8,
    	release_date Uint64,
	...
	seasonsCreateTable = `CREATE TABLE seasons (
    	series_id Uint64,
    	season_id Uint64,
    	title Utf8,
    	first_aired Uint64,
	...
	episodesCreateTable = `CREATE TABLE episodes (
    	series_id Uint64,
    	season_id Uint64,
    	episode_id Uint64,
    	title Utf8,
	...
	seriesData = `REPLACE INTO series (series_id, title, release_date, series_info) VALUES
    (
        1,
        "IT Crowd",
	...
	seasonsData = `REPLACE INTO seasons (series_id, season_id, title, first_aired, last_aired) VALUES
	...
	episodesData = `REPLACE INTO episodes (series_id, season_id, episode_id, title, air_date) VALUES
